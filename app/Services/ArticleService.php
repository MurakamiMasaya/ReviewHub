...
class ArticleService implements ArticleServiceInterface {
    ...
    public function getArticle($target, $column = null, $order = null, $period = null, $paginate = null, $limit = null, $before = null){
        return $this->articleRepository->getArticle($target, $column, $order, $period, $paginate, $limit, $before);
    }
