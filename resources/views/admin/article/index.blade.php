    ...
    <div class="max-w-4xl mx-auto my-10 px-2 md:px-10">
        <div class="justify-between items-start">
            <div class="flex justify-between items-start">
                <div class="flex">
                    <div class="text-xl font-bold md:mr-5">記事一覧</div>
                    <div class="hidden lg:flex">
                        <form action="{{ route('admin.article.search') }}" method="get">
                            <div class="flex">
                                <div class="flex items-center rounded-md px-2 bg-white mr-2 lg:mr-5 w-32 md:w-48">
                                    ...
                                    type="text" value="{{ $target }}" placeholder=記事を検索 />
        ...
        <div class="mt-5">
            <table class="mt-2 w-full">
                <tr>
                    <th class="border-r-2 border-gray-100 bg-gray-400 text-white text-xs p-1">記事名</th>
                ...
                <tr  class="border-b-2 border-gray-300">
                    <td class="w-3/12 text-xs">{!! nl2br(e($article->title)) !!}</td>
                    <td class="text-xs pt-2 line-clamp-5">{!! nl2br(e($article->contents)) !!}</td>
