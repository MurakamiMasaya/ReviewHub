<div class="mt-10 px-1 md:px-3 lg:px-5 text-gray-800">
    ...
    <div class="my-5 md:flex justify-around">
        <div class="md:w-1/2">
                ...
                <div class="mr-1 lg:mr-3">
                    <div class="flex justify-around">
                        <div class="flex items-end mt-5 justify-center">
                            ...
                            <div class="font-bold text-md lg:text-xl">
                                <a href="#">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="text-lg font-bold flex items-end">{{ $company->company_gr }}</div>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="mr-1 lg:mr-3">
                    <div class="flex justify-around">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="text-lg font-medium flex items-end">{{ $company->company_gr }}</div>
                        </div>
                    </div>
                </div>
                @endif
