@if(isset($route) && isset($para))
    ...
    <a href="{{ route($route) }}">
@endif
    <button type="{{ $type }}" name="back" value="true" class="flex justify-center items-center bg-white border-2 border-gray-400 rounded-lg px-3 py-2 w-48 lg:w-60 mx-auto">
