<div class="border-4 border-orange-500 mb-5 rounded-md">
                ...
                <div>
                    <div class="flex justify-between items-center mt-3 border-b border-gray-400">
                        <div class="flex items-center">
                            <div class="w-7 mr-1 md:text-md lg:text-lg font-bold text-red-800">{{ $loop->index+1 . '位' }}</div>
                        ...
                        <div class="flex">
                            ...
                            <div class="text-md font-bold flex items-end">{{ $school->gr }}</div>
                        </div>
                    </div>
                </div>
                @endforeach
